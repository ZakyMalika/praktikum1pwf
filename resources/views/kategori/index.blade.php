            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <div>
                            <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-200 tracking-tight">Kategori List
                            </h2>
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage your product categories</p>
                        </div>

                        {{-- <div class="flex items-center gap-3">
                            <x-add-product :url="route('kategori.create')" :name="'Kategori'" />
                        </div> --}}
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition duration-150">
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            <div class="flex items-center justify-center gap-2">
                                                ...
                                                <x-edit-product :url="route('kategori.edit', $kategori->id)" name="Edit Kategori" />
                                                <x-delete-product :url="route('kategori.delete', $kategori->id)" />
                                            </div>
                                        </td>
                                    </tr>
                                @empty
